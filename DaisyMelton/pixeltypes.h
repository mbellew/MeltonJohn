...
struct CRGB {
    ...
    static inline uint8_t qadd8(uint8_t a, uint8_t b)
    {
      ...
      return x > 0xff ? (uint8_t)0xff : (uint8_t)x;
    }
...
{
    return CRGB( CRGB::qadd8( p1.r, p2.r),
                 CRGB::qadd8( p1.g, p2.g),
                 CRGB::qadd8( p1.b, p2.b));
}
...
inline CRGB operator-( const CRGB& p1, const CRGB& p2)
{
    return CRGB( CRGB::qsub8( p1.r, p2.r),
                 CRGB::qsub8( p1.g, p2.g),
                 CRGB::qsub8( p1.b, p2.b));
}
